// This used to have strict mode enabled right before the consts, but I moved it to
// inside the "ChaCha" function so it won't auto-propagate to all scripts that use this program
// Source: https://github.com/skeeto/chacha-js
